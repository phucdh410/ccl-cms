...
const ConfirmPage = () => {
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-slate-200">
      <div className="flex flex-col items-center justify-center p-10 shadow-xl rounded-2xl bg-white gap-3">
        <h2 className="capitalize text-[3rem]">Thank you!</h2>
        ...
        <p>Your email is successfully registered to use login!</p>
        <p>Contact your administrator if you not have a password</p>
        <p className="text-xl">
          You can close this page now or trying login at&nbsp;
